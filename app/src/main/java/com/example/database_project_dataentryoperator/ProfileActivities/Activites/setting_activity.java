    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent=new Intent(setting_activity.this,main_dashboard_activity.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!username_tf_setting.getText().toString().trim().equals(prefreences.getString(getString(R.string.SharedPreferences_DataEntryOperatorEmail),"")))
                {
