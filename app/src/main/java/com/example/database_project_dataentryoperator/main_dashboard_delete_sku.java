...
public class main_dashboard_delete_sku extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        navigationView.setSpaceOnClickListener(new SpaceOnClickListener()
        {
            ...
            {
                Toast.makeText(main_dashboard_delete_sku.this,"onCentreButtonClick", Toast.LENGTH_SHORT).show();
                getSupportFragmentManager().beginTransaction().replace(R.id.main_dashboard_delete_container,delete_sku_fragment).commit();
            }
            ...
            {
                Toast.makeText(main_dashboard_delete_sku.this, itemIndex + " " + itemName, Toast.LENGTH_SHORT).show();
                if(itemIndex==0)
                {
